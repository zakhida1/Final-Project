...
Zakhida:
Soldered components. Participated in testing movement and motor behavior. Helped with final debugging and documentation. Integrated the DPST switch.

Medina:
Wrote the main code for obstacle detection and robot movement. Assembled the body. Added the separate motor for the cleaning brush and made brush itself. 

Zeide:
Worked on wiring the motors, connecting the L293D motor driver shield, and assembling the power system. Designed the chassis layout, mounted components.
